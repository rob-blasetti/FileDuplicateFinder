 ...
 */
public class FileClassifierBySize2Test {
    ...
    public void shouldClassifyFilesInFolderBySize() {
        ...
        FileClassifierBySize2 fileClassifierBySize2 = new FileClassifierBySize2(pathScanner, fileSizeReader);

        HashMap<String, ArrayList<String>> result = fileClassifierBySize2.scanDirectory("/path1");
